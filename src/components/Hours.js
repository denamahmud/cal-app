...
export default function Hours() {
  ...
  return (
     <div id='slider' className='flex horizontal-scroll-wrapper   cursor-grab overflow-x-scroll scroll scroll-smooth h-[520px] z-40 w-full mx-auto' onScroll={grapping1 } > 
        <div >
