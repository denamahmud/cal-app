...
export default function Hours() {
  ...
  return (
     <div id='slider' className='flex horizontal-scroll-wrapper   cursor-grab overflow-x-scroll scroll scroll-smooth h-[520px] z-40 w-full mx-auto' onMouseDown={grapping1 } draggable> 
        <div >
                <div className='fixed top-[99.9px] bg-white  flex w-20 h-20'>
                  ...
                  <h3 className='text-2xl text-gray-700 ml-10 md:text-md'>Jan</h3>
                </div>
                ...
                <div className='fixed top-[99.9px] right-5 z-10 flex flex-row-reverse bg-white'>
                  ...
                  <h3 className='text-2xl text-gray-700 mr-10 md:text-md '>Mar</h3> 
                </div>
